...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionMorceaux->setCheckable(true);
        actionMorceaux->setChecked(true);
        actionRadio = new QAction(MainWindow);
        actionRadio->setObjectName(QStringLiteral("actionRadio"));
        actionRadio->setCheckable(true);
        ...
        actionFrancais->setObjectName(QStringLiteral("actionFrancais"));
        ...
        actionOccitan->setCheckable(true);
        ...
        Connexion->setStyleSheet(QStringLiteral(""));
        Connexion->setChecked(false);
        ...
        menuLangues->addAction(actionDeutsch);
        menuLangues->addSeparator();
        menuLangues->addAction(actionEnglish);
        menuLangues->addSeparator();
        menuLangues->addAction(actionFrancais);
        menuLangues->addSeparator();
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionDeutsch->setText(QApplication::translate("MainWindow", "Deutsch", Q_NULLPTR));
        actionEnglish->setText(QApplication::translate("MainWindow", "English", Q_NULLPTR));
        actionFrancais->setText(QApplication::translate("MainWindow", "Fran\303\247ais", Q_NULLPTR));
